...
class Command(BaseCommand):
    help = 'Populates the database with default categories and products'
    ...
    def handle(self, *args, **options):
        ...
        # Create Categories
        shoes_cat = Category.objects.create(category_name="Shoes")
        clothes_cat = Category.objects.create(category_name="Clothes")
        acc_cat = Category.objects.create(category_name="Accessories")
        jewel_cat = Category.objects.create(category_name="Jewellery")
        ...
        products_data = [
          ...
          },
          {
            ...
            "price": 2800,
            "category": clothes_cat,
            "image": "https://images.unsplash.com/photo-1596783074918-c84cb06531ca?auto=format&fit=crop&w=500&q=80",
            "description": "An elegant, flowy designer silk gown in a deep emerald green, perfect for formal evening parties and festive occasions.",
            "stock": 15
          },
          {
            "name": "Gold Bangles",
            ...
            "description": "A pair of beautifully crafted traditional 22k gold bangles with intricate filigree work, representing timeless Indian elegance.",
            "stock": 10
          }
        ]
        ...
        self.stdout.write(self.style.SUCCESS("Database populated successfully with updated products!"))
